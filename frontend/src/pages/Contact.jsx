...
export default function Contact() {
  return (
    <section className="min-h-screen w-screen flex items-center justify-center">
      <section class="body-font relative text-3xl font-bold text-gray-800 dark:text-gray-200">

<div class="container mx-auto px-5 py-24">
  
  <div class="mb-12 flex w-full flex-col text-center">
    <h1 class="title-font mb-4 text-2xl font-medium  sm:text-3xl">Contact Us</h1>
